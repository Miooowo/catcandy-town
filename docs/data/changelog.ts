...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2025/11/22',
    added: [
      '镇长选举系统：城镇过完第一个月（30天）后进行镇长选举，居民通过公投选择值得信任的人选',
      '镇长特质影响：镇长的性格和特质会影响城镇的幸福度和居民生活体验',
      '洗脚店扶持政策：淫乱特质的镇长会扶持神秘洗脚店的发展，洗脚店获得更多利润，镇长从中收取税收',
      '动态人口迁入系统：根据工作岗位数量动态调节居民迁入速度',
      '随机NPC名称：默认居民名称改为随机生成，不再使用固定名称列表',
      '城镇管理局建筑：严肃性格的居民会优先建造城镇管理局，配备3个城管工作人员',
      '举报系统：居民可以向城镇管理局举报其他居民的违规行为（非正当关系、贿赂、暴力等）',
      '城镇管理局核实与惩罚：管理局会对举报进行核实，对违规人员进行罚款并降低可信度',
      '秘密房间（隐藏建筑）：只有拥有淫乱特质的居民大于半数时才会显示',
      '秘密房间锁门机制：当有2个及以上的人进入时自动锁门'
    ],
    changed: [
      '人口迁入机制优化：当工作岗位大于居民时，5天后迁入新居民；当居民大于岗位时，放慢到1个月；如果迁入后仍然居民>岗位，放慢到3个月',
      '更新日志UI优化：修复标题重复显示问题，加大标题字体',
      '纯爱模式优化：进一步确保所有非正当发生关系都被禁止',
      '建筑显示机制：隐藏建筑根据条件动态显示，隐藏期间不可建造',
      '城镇管理局功能：居民不能在城镇管理局放松，只能进行举报或咨询事务'
    ]
  },
  {
    version: '1.6.1',
